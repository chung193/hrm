    ...
    useEffect(() => {
        ...
        showFn(id).then((res) => {
            ...
            reset({
                ...
                organization_id: detail.organization_id ? String(detail.organization_id) : '',
                department_id: detail.department_id ? String(detail.department_id) : '',
                department_title_id: detail.department_title_id ? String(detail.department_title_id) : '',
                phone: detail.phone || '',
